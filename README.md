...
<p align="center">
  ...
  <img alt="Version 0.3.0" src="https://img.shields.io/badge/version-0.3.0-0f766e">
...
| `registry/releases/v0.3.0.json` | Versioned release manifest with file checksums and registry counts for reproducible snapshots. |
...
`v0.3.0` is the current stable registry snapshot. The registry remains
conservative about maturity: skills stay `seed` until domain review and public
evidence support promotion. This release adds security, compatibility, quality,
and benchmark-review infrastructure without claiming measured agent lift. The
current focus is on:
