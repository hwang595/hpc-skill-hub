...
The seed registry includes 50 skills covering Slurm, modules, Apptainer, Spack,
...
Jupyter notebooks, Python/Conda environments, Rscript, Julia, and MATLAB batch
jobs, compiler/MPI compatibility,
