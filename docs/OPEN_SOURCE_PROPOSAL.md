...
The seed registry includes 49 skills covering Slurm, modules, Apptainer, Spack,
...
Jupyter notebooks, Python/Conda environments, Rscript and Julia batch jobs,
compiler/MPI compatibility,
