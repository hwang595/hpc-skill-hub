...
The seed registry includes 36 skills covering Slurm, modules, Apptainer, Spack,
...
checks. It also includes nf-core and GATK on Slurm, six curated collections,
and one example site adapter.
