...
The seed registry includes 58 skills covering Slurm, modules, Apptainer, Spack,
...
nf-core, GATK, local BLAST+, LAMMPS, GROMACS, NAMD, Quantum ESPRESSO, OpenFOAM,
and WRF on Slurm, read-only facility usage reporting, node triage, module tree
