...
The seed registry includes 25 skills covering Slurm, modules, Apptainer, Spack,
...
compatibility, and reproducible run capture. It also includes one example site
adapter.
