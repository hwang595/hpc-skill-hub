...
The seed registry includes 77 skills covering Slurm, PBS/OpenPBS, LSF, HTCondor, Grid Engine, modules, Apptainer, containerized MPI, Spack,
EasyBuild, Globus, CWL, WDL, Nextflow, Snakemake, MPI, GPU sanity checks, and basic
profiling, MPI rank binding diagnostics, license-aware Slurm jobs, plus storage, quota, arrays, dependency chains, pending reason
