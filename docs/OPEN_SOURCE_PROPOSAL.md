...
The seed registry includes 67 skills covering Slurm, PBS/OpenPBS, LSF, HTCondor, Grid Engine, modules, Apptainer, containerized MPI, Spack,
...
Jupyter notebooks, Streamlit apps, RStudio sessions, VS Code tunnels, Python/Conda environments, Ray, Dask Jobqueue, mpi4py,
