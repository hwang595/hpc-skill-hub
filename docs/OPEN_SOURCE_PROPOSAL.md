...
The seed registry includes 30 skills covering Slurm, modules, Apptainer, Spack,
...
manifests, rsync transfer, scratch staging, and archive preparation. It also
includes one example site adapter.
