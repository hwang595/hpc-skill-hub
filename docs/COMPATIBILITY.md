...
| `slurm` | 51 | `admin`, `containers`, `data`, `debugging`, `education`, `gpu`, `interactive`, `mpi`, `performance`, `scheduler`, `software`, `workflow` | `ai-hpc`, `bioinformatics-workflows`, `containers`, `core-hpc`, `data-movement`, `facility-ops`, `gpu-mpi-performance`, `scheduler-basics`, `simulation-workflows`, `software-stacks`, `training-onboarding`, `workflow-engines` |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| [`ai-hpc`](../collections/ai-hpc.json) | 15 | 0 | 1 | 1 | 7 | 0 | 7 | 2 | 0 | 1 | 13 | 6 | 1 |
...
| [`gpu-mpi-performance`](../collections/gpu-mpi-performance.json) | 16 | 0 | 1 | 1 | 8 | 0 | 7 | 1 | 5 | 5 | 13 | 5 | 0 |
...
| [`software-stacks`](../collections/software-stacks.json) | 23 | 1 | 3 | 0 | 5 | 1 | 2 | 5 | 3 | 1 | 14 | 21 | 1 |
...
| --- | ---: | --- | --- |
| [`ai-hpc`](../collections/ai-hpc.json) | 15 | `scheduler` (13), `debugging` (7), `gpu` (7), `software` (6) | AI/HPC users, machine learning researchers, research software engineers, HPC support teams |
