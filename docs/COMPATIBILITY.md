...
| `slurm` | 50 | `admin`, `containers`, `data`, `debugging`, `education`, `gpu`, `interactive`, `mpi`, `performance`, `scheduler`, `software`, `workflow` | `ai-hpc`, `bioinformatics-workflows`, `containers`, `core-hpc`, `data-movement`, `facility-ops`, `gpu-mpi-performance`, `scheduler-basics`, `simulation-workflows`, `software-stacks`, `training-onboarding`, `workflow-engines` |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| [`ai-hpc`](../collections/ai-hpc.json) | 14 | 0 | 1 | 1 | 7 | 0 | 6 | 2 | 0 | 1 | 12 | 5 | 1 |
...
| [`data-movement`](../collections/data-movement.json) | 8 | 0 | 0 | 8 | 2 | 0 | 0 | 0 | 1 | 1 | 2 | 0 | 0 |
| [`facility-ops`](../collections/facility-ops.json) | 4 | 3 | 0 | 0 | 3 | 0 | 0 | 0 | 0 | 0 | 3 | 1 | 0 |
| [`gpu-mpi-performance`](../collections/gpu-mpi-performance.json) | 15 | 0 | 1 | 1 | 8 | 0 | 6 | 1 | 5 | 5 | 12 | 4 | 0 |
...
| [`software-stacks`](../collections/software-stacks.json) | 22 | 1 | 3 | 0 | 5 | 1 | 1 | 5 | 3 | 1 | 13 | 20 | 1 |
...
| Python | [`dask-jobqueue-on-slurm`](../skills/dask-jobqueue-on-slurm/README.md), [`deepspeed-on-slurm`](../skills/deepspeed-on-slurm/README.md), [`gpu-memory-triage`](../skills/gpu-memory-triage/README.md), [`ior-mdtest-storage-smoke`](../skills/ior-mdtest-storage-smoke/README.md), [`jupyter-on-slurm`](../skills/jupyter-on-slurm/README.md), [`mpi4py-on-slurm`](../skills/mpi4py-on-slurm/README.md), [`python-virtualenv-on-hpc`](../skills/python-virtualenv-on-hpc/README.md), [`pytorch-ddp-on-slurm`](../skills/pytorch-ddp-on-slurm/README.md), [`ray-on-slurm`](../skills/ray-on-slurm/README.md), [`streamlit-on-slurm`](../skills/streamlit-on-slurm/README.md), [`tensorboard-on-slurm`](../skills/tensorboard-on-slurm/README.md) |
...
| --- | ---: | --- | --- |
| [`ai-hpc`](../collections/ai-hpc.json) | 14 | `scheduler` (12), `debugging` (7), `gpu` (6), `software` (5) | AI/HPC users, machine learning researchers, research software engineers, HPC support teams |
...
| [`data-movement`](../collections/data-movement.json) | 8 | `data` (8), `debugging` (2), `scheduler` (2), `mpi` (1) | data stewards, research groups, facility support teams |
...
`all_reduce_perf`, `basename`, `bjobs`, `blastn`, `blockMesh`, `bsub`, `charmrun`, `clang`, `code`, `conda`, `condor_q`, `condor_rm`, `condor_submit`, `cp2k.psmp`, `cwltool`, `dask`, `dask_jobqueue`, `decomposePar`, `deepspeed`, `distributed`, `eb`, `gatk`, `gcc`, `git`, `globus`, `gmx`, `gmx_mpi`, `icoFoam`, `ior`, `julia`, `jupyter`, `lmp`, `ln`, `lscpu`, `makeblastdb`, `mamba`, `matlab`, `mdtest`, `micromamba`, `miniwdl`, `mpi4py`, `mpicxx`, `mpiexec`, `mpifort`, `namd2`, `ncdump`, `nproc`, `Open OnDemand`, `perf`, `pip`, `printenv`, `pw.x`, `qdel`, `quota`, `R`, `ray`, `real.exe`, `reconstructPar`, `rm`, `Rscript`, `rserver`, `salloc`, `seff`, `singularity`, `sleep`, `snakemake`, `spack`, `sprio`, `sreport`, `streamlit`, `tar`, `tensorboard`, `time`, `tr`, `uname`, `wc`, `wrf.exe`.
