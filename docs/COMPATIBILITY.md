...
| `slurm` | 46 | `admin`, `containers`, `data`, `debugging`, `education`, `gpu`, `interactive`, `mpi`, `performance`, `scheduler`, `software`, `workflow` | `ai-hpc`, `bioinformatics-workflows`, `containers`, `core-hpc`, `data-movement`, `facility-ops`, `gpu-mpi-performance`, `scheduler-basics`, `simulation-workflows`, `software-stacks`, `training-onboarding`, `workflow-engines` |
...
| [`software-stacks`](../collections/software-stacks.json) | 19 | 1 | 3 | 0 | 4 | 0 | 1 | 2 | 3 | 1 | 10 | 17 | 1 |
| [`training-onboarding`](../collections/training-onboarding.json) | 14 | 1 | 0 | 1 | 2 | 1 | 0 | 4 | 0 | 0 | 11 | 8 | 0 |
...
| [`training-onboarding`](../collections/training-onboarding.json) | 14 | `scheduler` (11), `software` (8), `interactive` (4), `debugging` (2) | instructors, new HPC users, training cluster maintainers |
