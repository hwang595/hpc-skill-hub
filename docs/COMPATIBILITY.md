...
| `slurm` | 49 | `admin`, `containers`, `data`, `debugging`, `education`, `gpu`, `interactive`, `mpi`, `performance`, `scheduler`, `software`, `workflow` | `ai-hpc`, `bioinformatics-workflows`, `containers`, `core-hpc`, `data-movement`, `facility-ops`, `gpu-mpi-performance`, `scheduler-basics`, `simulation-workflows`, `software-stacks`, `training-onboarding`, `workflow-engines` |
...
| [`software-stacks`](../collections/software-stacks.json) | 21 | 1 | 3 | 0 | 5 | 0 | 1 | 4 | 3 | 1 | 12 | 19 | 1 |
| [`training-onboarding`](../collections/training-onboarding.json) | 16 | 1 | 0 | 1 | 3 | 1 | 0 | 6 | 0 | 0 | 13 | 10 | 0 |
...
| [`training-onboarding`](../collections/training-onboarding.json) | 16 | `scheduler` (13), `software` (10), `interactive` (6), `debugging` (3) | instructors, new HPC users, training cluster maintainers |
