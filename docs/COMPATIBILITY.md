...
| `lsf` | 2 | `debugging`, `performance`, `scheduler`, `software`, `workflow` | `scheduler-basics`, `simulation-workflows` |
| `openpbs` | 2 | `debugging`, `performance`, `scheduler`, `software`, `workflow` | `scheduler-basics`, `simulation-workflows` |
| `pbs` | 2 | `debugging`, `performance`, `scheduler`, `software`, `workflow` | `scheduler-basics`, `simulation-workflows` |
| `pbs-pro` | 2 | `debugging`, `performance`, `scheduler`, `software`, `workflow` | `scheduler-basics`, `simulation-workflows` |
...
| `slurm` | 70 | `admin`, `containers`, `data`, `debugging`, `education`, `gpu`, `interactive`, `mpi`, `performance`, `scheduler`, `software`, `workflow` | `ai-hpc`, `bioinformatics-workflows`, `containers`, `core-hpc`, `data-movement`, `facility-ops`, `gpu-mpi-performance`, `scheduler-basics`, `simulation-workflows`, `software-stacks`, `training-onboarding`, `workflow-engines` |
...
| [`simulation-workflows`](../collections/simulation-workflows.json) | 21 | 0 | 0 | 4 | 11 | 0 | 3 | 0 | 15 | 17 | 15 | 4 | 1 |
...
| [`simulation-workflows`](../collections/simulation-workflows.json) | 21 | `performance` (17), `mpi` (15), `scheduler` (15), `debugging` (11) | simulation teams, computational scientists, performance engineers |
