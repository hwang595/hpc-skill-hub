...
| `slurm` | 47 | `admin`, `containers`, `data`, `debugging`, `education`, `gpu`, `interactive`, `mpi`, `performance`, `scheduler`, `software`, `workflow` | `ai-hpc`, `bioinformatics-workflows`, `containers`, `core-hpc`, `data-movement`, `facility-ops`, `gpu-mpi-performance`, `scheduler-basics`, `simulation-workflows`, `software-stacks`, `training-onboarding`, `workflow-engines` |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| [`ai-hpc`](../collections/ai-hpc.json) | 13 | 0 | 1 | 1 | 6 | 0 | 6 | 1 | 0 | 1 | 11 | 4 | 1 |
...
| [`software-stacks`](../collections/software-stacks.json) | 20 | 1 | 3 | 0 | 4 | 0 | 1 | 3 | 3 | 1 | 11 | 18 | 1 |
| [`training-onboarding`](../collections/training-onboarding.json) | 15 | 1 | 0 | 1 | 2 | 1 | 0 | 5 | 0 | 0 | 12 | 9 | 0 |
...
| Python | [`dask-jobqueue-on-slurm`](../skills/dask-jobqueue-on-slurm/README.md), [`deepspeed-on-slurm`](../skills/deepspeed-on-slurm/README.md), [`gpu-memory-triage`](../skills/gpu-memory-triage/README.md), [`jupyter-on-slurm`](../skills/jupyter-on-slurm/README.md), [`mpi4py-on-slurm`](../skills/mpi4py-on-slurm/README.md), [`python-virtualenv-on-hpc`](../skills/python-virtualenv-on-hpc/README.md), [`pytorch-ddp-on-slurm`](../skills/pytorch-ddp-on-slurm/README.md), [`ray-on-slurm`](../skills/ray-on-slurm/README.md), [`streamlit-on-slurm`](../skills/streamlit-on-slurm/README.md) |
...
| --- | ---: | --- | --- |
| [`ai-hpc`](../collections/ai-hpc.json) | 13 | `scheduler` (11), `debugging` (6), `gpu` (6), `software` (4) | AI/HPC users, machine learning researchers, research software engineers, HPC support teams |
...
| [`training-onboarding`](../collections/training-onboarding.json) | 15 | `scheduler` (12), `software` (9), `interactive` (5), `debugging` (2) | instructors, new HPC users, training cluster maintainers |
