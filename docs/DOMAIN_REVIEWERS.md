...
| --- | --- | --- |
| Scheduler and allocation | Slurm jobs, arrays, dependencies, pending reasons, accounting, time limits, partitions, reservations, preemption, and requeue behavior. | `core-hpc`, `slurm-submit-job`, `slurm-job-array-patterns`, `slurm-job-dependency-chain`, `slurm-pending-reason-triage`, `slurm-monitor-job`, `slurm-resource-estimator`, `slurm-efficiency-report`, `slurm-preemption-requeue` |
