...
| Simulation workflows | Molecular dynamics, electronic structure, CFD, weather, MPI decomposition, MPI fabric diagnostics, hybrid MPI/OpenMP layouts, rank binding diagnostics, parallel HDF5/NetCDF preflight, storage smoke evidence, checkpointing, and restart policy. | `simulation-workflows`, `gromacs-on-slurm`, `lammps-on-slurm`, `quantum-espresso-on-slurm`, `openfoam-on-slurm`, `wrf-on-slurm`, `mpi-fabric-diagnostics`, `hybrid-mpi-openmp-slurm`, `mpi-rank-binding-diagnostics`, `parallel-hdf5-netcdf-preflight`, `ior-mdtest-storage-smoke` |
