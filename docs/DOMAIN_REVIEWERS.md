...
| --- | --- | --- |
| Scheduler and allocation | Slurm jobs, arrays, failed-array retry planning, dependencies, output logs, pending reasons, maintenance windows, reservations, QOS/account limits, accounting, memory limits, time limits, node failures, partitions, preemption, and requeue behavior. | `core-hpc`, `slurm-submit-job`, `slurm-job-array-patterns`, `slurm-array-retry-plan`, `slurm-job-dependency-chain`, `slurm-pending-reason-triage`, `slurm-maintenance-reservation-triage`, `slurm-qos-account-limit-triage`, `slurm-monitor-job`, `slurm-output-log-triage`, `slurm-resource-estimator`, `slurm-oom-memory-triage`, `slurm-time-limit-triage`, `slurm-node-failure-triage`, `slurm-efficiency-report`, `slurm-preemption-requeue` |
